...
export const hyderabadCommunities = [
  "My Home Bhooja",
  "My Home Avatar",
  "My Home Mangala",
  "My Home Vihanga",
...
export const hyderabadITCorridorLocations = [
  "Mindspace Madhapur",
  "Cyber Towers Area",
  "Cyber Gateway",
  "RMZ Nexity",
...
export const hyderabadGrowthZones = [
...
export const hyderabadPremiumAreas = [
...
export const hyderabadSearchVariations = [
  "KPHB Phase 1",
  "KPHB Phase 2",
  "KPHB Phase 3",
  "KPHB Phase 4",
