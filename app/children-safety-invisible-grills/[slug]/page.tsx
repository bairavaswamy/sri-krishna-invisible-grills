...
import { locationHash, slugify, locationImages, createGrillSeed, locationImagesForChildrenSafetyInvisibleGrills, BalconySafetyChildrenSafetyInvisibleGrills, } from "../../components/seo/utils";
...
<div className="relative bg-white md:bg-[#f1f5f9] md:w-[75%] -mt-[15px] md:-mt-[65px] p-4 md:p-6 rounded-2xl md:rounded-none shadow-xl mx-auto">
  ...
  <div className="relative w-full md:w-[100%] h-[300px] md:h-[350px] rounded-xl overflow-hidden shadow-2xl mx-auto">
    ...
    <Image
      ...
      alt={`children safety Invisible grill installation in ${page.location}`}
      title={`children safety Invisible grills near me in ${page.location}`}
      fill
...
{section.heading.includes("How Children Safety Invisible Grills Help Keep Birds Away") && (
  <div className="relative w-full h-[260px] md:h-[320px] my-6 rounded-xl overflow-hidden">
    ...
    <Image
      ...
      alt={`children safety Invisible grill installation near me ${page.location}`}
      title={`children safety Invisible grills near me in ${page.location} Hyderabad`}
      fill
      className="object-cover transition-transform duration-700 hover:scale-105"
      priority
    />
  ...
  Need Children safety Invisible Grills in {page.location}?
  </h2>

  <p className="mb-6">
  Contact Rohini Invisible Grills today for professional installation.
  Protect your balcony and keep birds away and Secure Your Balcony with children safety invisible grills.
  </p>
